...
SRCS             = Src/main.c Src/stm32f1xx_it.c Src/system_stm32f1xx.c Src/usbd_conf.c Src/usbd_desc.c Src/usbd_customhid_if.c Src/usbd_customhid.c
...
SRCS            += $(STM32SDK)/Middlewares/ST/STM32_USB_Device_Library/Core/Src/usbd_ctlreq.c
...
CFLAGS          += -MD -g -Os -ffunction-sections -fdata-sections
CFLAGS          += -flto
CFLAGS          += -c $(CPUFLAGS)
CFLAGS          += -std=gnu99
