...
#define USBD_CDC_ACM_WMAXPACKETSIZE     CDC_CMD_PACKET_SIZE
#define USBD_CDC_ACM_BINTERVAL          64
...
#define USBD_CDC_ACM_WMAXPACKETSIZE1    CDC_DATA_FS_MAX_PACKET_SIZE
#define USBD_CDC_ACM_CIF_STRDESC        L"Alt-Link Serial Port (4.5Mbps)"
#define USBD_CDC_ACM_DIF_STRDESC        L"Alt-Link Serial Port DIF (4.5Mbps)"
#define USBD_CDC_ACM_CIF_STRDESC2       L"Alt-Link Serial Port (2.25Mbps)"
#define USBD_CDC_ACM_DIF_STRDESC2       L"Alt-Link Serial Port DIF (2.25Mbps)"
...
#define USBD_IF_NUM                (USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+(USBD_CDC_ACM_ENABLE*2)+(CDC_ENDPOINT2*USBD_CDC_ACM_ENABLE*2)+USBD_CLS_ENABLE+USBD_I2C_ENABLE)
...
#define USBD_EP_NUM_CALC7           MAX((CDC_ENDPOINT2*(USBD_CDC_ACM_EP_BULKIN)), (CDC_ENDPOINT2*(USBD_CDC_ACM_EP_BULKOUT)))
...
#define USBD_CDC_ACM_CIF_NUM2      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+CDC_ENDPOINT2*2)
#define USBD_CDC_ACM_DIF_NUM2      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+CDC_ENDPOINT2*2+1)
#define USBD_HID_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2)
#define USBD_I2C_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+USBD_HID_ENABLE)
...
#define USBD_HID_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+USBD_HID_ENABLE)
#define USBD_I2C_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+USBD_HID_ENABLE+USBD_MSC_ENABLE)
