...
#pragma pack(1)
#define DAPLINK_VERSION 241
#define HID_ENDPOINT
//DAPLINK_VERSION=241, HID_ENDPOINT, MSC_ENDPOINT, CDC_ENDPOINT, DAPLINK_IF, DAPLINK_BUILD_KEY=0x9B939E8F, INTERFACE_STM32F103XB, CPU_STM32F103RBT6, USE_STDPERIPH_DRIVER, STM32F10X_MD, DAPLINK_HIC_ID=0x97969904, BL_TARGET_FLASH, USE_HSE_16MHZ
...
//   </h>
#define USBD_POWER                  0
#define USBD_MAX_PACKET0            USB_MAX_EP0_SIZE
//#define USBD_DEVDESC_IDVENDOR       0x0D28
//#define USBD_DEVDESC_IDPRODUCT      0x0204
#define USBD_DEVDESC_IDVENDOR       0x1c40
#define USBD_DEVDESC_IDPRODUCT      0x0534
...
#define USBD_STRDESC_MAN            L"Alt-Link"
#define USBD_STRDESC_PROD           L"Alt-Link CMSIS-DAP"
#define USBD_STRDESC_SER_ENABLE     1
#define USBD_STRDESC_SER            L"8D732F775753"
...
#endif
#ifndef CDC_ENDPOINT2
#define CDC_ENDPOINT2 0
#else
#undef CDC_ENDPOINT2
#define CDC_ENDPOINT2 1
#endif
#ifndef CDC_ENDPOINT3
#define CDC_ENDPOINT3 0
#else
#undef CDC_ENDPOINT3
#define CDC_ENDPOINT3 1
#endif

#define USBD_CDC_ACM_ENABLE             CDC_ENDPOINT
#define USBD_CDC_ACM_EP_INTIN           (CDC_CMD_EP  - 0x80)
#define USBD_CDC_ACM_EP_INTIN2          (CDC_CMD_EP2 - 0x80)
#define USBD_CDC_ACM_EP_INTIN3          (CDC_CMD_EP3 - 0x80)
#define USBD_CDC_ACM_EP_INTIN_STACK     0
#define USBD_CDC_ACM_CMD_PACKETSIZE     CDC_CMD_PACKET_SIZE
#define USBD_CDC_ACM_BINTERVAL          10
#define USBD_CDC_ACM_EP_BULKIN          (CDC_IN_EP - 0x80)
#define USBD_CDC_ACM_EP_BULKOUT         CDC_OUT_EP
#define USBD_CDC_ACM_EP_BULKIN2         (CDC_IN_EP2 - 0x80)
#define USBD_CDC_ACM_EP_BULKOUT2        CDC_OUT_EP2
#define USBD_CDC_ACM_EP_BULKIN3         (CDC_IN_EP3 - 0x80)
#define USBD_CDC_ACM_EP_BULKOUT3        CDC_OUT_EP3
#define USBD_CDC_ACM_EP_BULKIN_STACK    0
#define USBD_CDC_ACM_DATA_PACKETSIZE    CDC_DATA_FS_MAX_PACKET_SIZE
#define USBD_CDC_ACM_CIF_STRDESC        L"Alt-Link USART1 (4.5Mbps)"
#define USBD_CDC_ACM_DIF_STRDESC        L"Alt-Link USART1 DIF (4.5Mbps)"
#define USBD_CDC_ACM_CIF_STRDESC2       L"Alt-Link USART2 (2.25Mbps)"
#define USBD_CDC_ACM_DIF_STRDESC2       L"Alt-Link USART2 DIF (2.25Mbps)"
#define USBD_CDC_ACM_CIF_STRDESC3       L"Alt-Link USART3 / Serial Line CAN (SLCAN) Interface"
#define USBD_CDC_ACM_DIF_STRDESC3       L"Alt-Link USART3 / Serial Line CAN (SLCAN) Interface DIF"
#define USBD_CDC_ACM_SENDBUF_SIZE       CDC_DATA_FS_MAX_PACKET_SIZE
#define USBD_CDC_ACM_RECEIVEBUF_SIZE    CDC_DATA_FS_MAX_PACKET_SIZE
#if (((USBD_CDC_ACM_HS_ENABLE1) && (USBD_CDC_ACM_SENDBUF_SIZE    < USBD_CDC_ACM_HS_WMAXPACKETSIZE1)) || (USBD_CDC_ACM_SENDBUF_SIZE    < USBD_CDC_ACM_DATA_PACKETSIZE))
#error "Send Buffer size must be larger or equal to Bulk In maximum packet size!"
#endif
#if (((USBD_CDC_ACM_HS_ENABLE1) && (USBD_CDC_ACM_RECEIVEBUF_SIZE < USBD_CDC_ACM_HS_WMAXPACKETSIZE1)) || (USBD_CDC_ACM_RECEIVEBUF_SIZE < USBD_CDC_ACM_DATA_PACKETSIZE))
...
#define USBD_I2C_ENABLE            1
#define USBD_I2C_STRDESC           L"Alt-Link i2c-tiny-usb"


/* USB Device Calculations ---------------------------------------------------*/

#define USBD_IF_NUM                (USBD_HID_ENABLE+USBD_MSC_ENABLE+(USBD_ADC_ENABLE*2)+((USBD_CDC_ACM_ENABLE+CDC_ENDPOINT2+CDC_ENDPOINT3)*2)+USBD_CLS_ENABLE+USBD_I2C_ENABLE)
#define USBD_MULTI_IF              (USBD_CDC_ACM_ENABLE*(USBD_HID_ENABLE|USBD_MSC_ENABLE|USBD_ADC_ENABLE|USBD_I2C_ENABLE))
#define MAX(x, y)                (((x) < (y)) ? (y) : (x))

#if    (CDC_ENDPOINT2)
#if    (CDC_ENDPOINT)
#else
#error "CDC_ENDPOINT should be defined!"
#endif
#endif
...
#endif
#if  (((USBD_HID_EP_INTIN   == USBD_CDC_ACM_EP_INTIN2)   || \
       (USBD_HID_EP_INTIN   == USBD_CDC_ACM_EP_BULKIN2)  || \
       (USBD_HID_EP_INTIN   == USBD_CDC_ACM_EP_BULKOUT2))|| \
      ((USBD_HID_EP_INTOUT  != 0)                       && \
      ((USBD_HID_EP_INTOUT  == USBD_CDC_ACM_EP_INTIN2)   || \
       (USBD_HID_EP_INTOUT  == USBD_CDC_ACM_EP_BULKIN2)  || \
       (USBD_HID_EP_INTOUT  == USBD_CDC_ACM_EP_BULKOUT2))))
#error "HID and Communication Device Interface can not use same Endpoints!"
#endif
#endif
#endif
...
#endif
#if   ((USBD_MSC_EP_BULKIN  == USBD_CDC_ACM_EP_INTIN2)   || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_ACM_EP_BULKIN2)  || \
       (USBD_MSC_EP_BULKIN  == USBD_CDC_ACM_EP_BULKOUT2) || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_ACM_EP_INTIN2)   || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_ACM_EP_BULKIN2)  || \
       (USBD_MSC_EP_BULKOUT == USBD_CDC_ACM_EP_BULKOUT2))
#error "Mass Storage Device and Communication Device Interface can not use same Endpoints!"
#endif
#endif
#endif
...
#endif
#if   ((USBD_ADC_EP_ISOOUT  == USBD_CDC_ACM_EP_INTIN2)   || \
       (USBD_ADC_EP_ISOOUT  == USBD_CDC_ACM_EP_BULKIN2)  || \
       (USBD_ADC_EP_ISOOUT  == USBD_CDC_ACM_EP_BULKOUT2))
#error "Audio Device and Communication Device Interface can not use same Endpoints!"
#endif
#endif
#endif
...
#define USBD_CDC_ACM_CIF_NUM2      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2)
#define USBD_CDC_ACM_DIF_NUM2      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+1)
#define USBD_CDC_ACM_CIF_NUM3      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2)
#define USBD_CDC_ACM_DIF_NUM3      (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+1)
#define USBD_HID_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+CDC_ENDPOINT3*2)
#define USBD_I2C_IF_NUM            (USBD_ADC_ENABLE*2+USBD_MSC_ENABLE*1+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+CDC_ENDPOINT3*2+USBD_HID_ENABLE)
...
#define USBD_CDC_ACM_CIF_STR_NUM2  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+0)
#define USBD_CDC_ACM_DIF_STR_NUM2  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+1)
#define USBD_CDC_ACM_CIF_STR_NUM3  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+0)
#define USBD_CDC_ACM_DIF_STR_NUM3  (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+1)
#define USBD_HID_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+CDC_ENDPOINT3*2)
#define USBD_MSC_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+CDC_ENDPOINT3*2+USBD_HID_ENABLE)
#define USBD_I2C_IF_STR_NUM        (3+USBD_STRDESC_SER_ENABLE+USBD_ADC_ENABLE*3+USBD_CDC_ACM_ENABLE*2+CDC_ENDPOINT2*2+CDC_ENDPOINT3*2+USBD_HID_ENABLE+USBD_MSC_ENABLE)
...
#define USBD_CDC_ACM_MAX_PACKET   ((USBD_CDC_ACM_HS_WMAXPACKETSIZE > USBD_CDC_ACM_CMD_PACKETSIZE) ? USBD_CDC_ACM_HS_WMAXPACKETSIZE : USBD_CDC_ACM_CMD_PACKETSIZE)
#else
#define USBD_CDC_ACM_MAX_PACKET    (USBD_CDC_ACM_CMD_PACKETSIZE)
#endif
#if    (USBD_CDC_ACM_HS_ENABLE1)
#define USBD_CDC_ACM_MAX_PACKET1  ((USBD_CDC_ACM_HS_WMAXPACKETSIZE1 > USBD_CDC_ACM_DATA_PACKETSIZE) ? USBD_CDC_ACM_HS_WMAXPACKETSIZE1 : USBD_CDC_ACM_DATA_PACKETSIZE)
#else
#define USBD_CDC_ACM_MAX_PACKET1   (USBD_CDC_ACM_DATA_PACKETSIZE)
#endif
#else
